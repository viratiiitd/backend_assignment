...
# _____________________________This is the original code above this____________________________

#____________________________new code trial____________________________
# async def generate_summary_with_llm(messages: List[Dict[str, Any]]):
#     if not messages:
#         return "No messages to summarize."
...
#             return f"This is a mock summary of {message_count} messages. In a production environment, this would be generated by OpenAI's GPT-3.5. The conversation appears to discuss various topics and has contributions from {len(set([msg['user_id'] for msg in messages]))} unique participants."
#some testing 
...
# _________________This is the original code below this____________________
...
# __________________________This is the original code above this____________________________
...
#             return {
#                 "sentiment": "positive",
#                 "topics": ["mock topic 1", "mock topic 2", "development discussion"],
#                 "keywords": ["api", "development", "chat", "summarization", "mock"]
#             }
